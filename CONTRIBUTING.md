...
If you want to help resolve an issue by making some changes that are larger than that covered by the above paragraph, it is recommended that you fork the repository on Github and clone your fork to your computer. Once you have a development setup, you should:
